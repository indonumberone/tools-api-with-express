...
app.get("/about", async (req, res) => {
  ...
  for (let i = 2423600031; i <= 2423600060; i++) {
    if (i !== 2423600039 && i !== 2423600046 && i !== 2423600051 && i !== 2423600052 && i !== 2423600054 && i !== 2423600057 && i !== 2423600059) {
      let response = await axios.get(`https://api-frontend.kemdikbud.go.id/hit_mhs/${i}`);
      let nama;
